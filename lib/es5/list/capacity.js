...
var Collector = (function () {
    ...
    Collector.default = function (count, prepend) {
        var c = Collector._default;
        c.elements = new Array(count);
        c.index = prepend ? count : 0;
        return c;
    };
    Collector.one = function (elements) {
        var c = this._default;
        c.elements = [elements];
        return c;
    };
    Collector.prototype.set = function (elements) {
        this.elements[this.index] = elements;
        this.index++;
    };
    Collector.prototype.mark = function () {
        this.marker = this.index;
    };
    Collector.prototype.restore = function () {
        this.index = this.marker;
    };
    Collector.prototype.populate = function (values, innerIndex) {
