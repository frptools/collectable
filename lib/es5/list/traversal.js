...
var TreeWorker = (function () {
    ...
    TreeWorker._getDefaults = function () {
    ...
    TreeWorker.defaultPrimary = function () {
        return TreeWorker._getDefaults().defaultPrimary;
    };
    TreeWorker.defaultSecondary = function () {
        return TreeWorker._getDefaults().defaultSecondary;
    };
    TreeWorker.defaultOther = function () {
        return TreeWorker._getDefaults().defaultOther;
    };
    TreeWorker.defaultTemporary = function () {
        return TreeWorker._getDefaults().defaultTemporary;
    };
    TreeWorker.refocusView = function (state, view, ordinal, asAltView, asWriteTarget) {
    ...
    TreeWorker.focusOrdinal = function (state, ordinal, asWriteTarget) {
    ...
    TreeWorker.focusEdge = function (state, edge, asWriteTarget) {
    ...
    TreeWorker.focusHead = function (state, asWriteTarget) {
        return TreeWorker.focusEdge(state, 0, asWriteTarget);
    };
    TreeWorker.focusTail = function (state, asWriteTarget) {
        return TreeWorker.focusEdge(state, 1, asWriteTarget);
    };
    TreeWorker.focusView = function (state, ordinal, anchor, asWriteTarget) {
        var view = state_1.getView(state, anchor, true, ordinal);
        return isViewInRange(view, ordinal, state.size) ? view
            : TreeWorker.refocusView(state, view, ordinal, false, true);
    };
    TreeWorker.prototype.isRoot = function () {
        return this.current.isRoot();
    };
    TreeWorker.prototype.hasOtherView = function () {
        return !this.other.isNone();
    };
    TreeWorker.prototype.isOtherViewUncommitted = function () {
        return !this.committedOther && !this.other.isNone();
    };
    TreeWorker.prototype.reset = function (state, view, group, otherCommitMode) {
        if (otherCommitMode === void 0) { otherCommitMode = 0; }
        this.state = state;
        this.current = view;
        this.group = group;
        this.shift = 0;
    ...
    TreeWorker.prototype.dispose = function () {
        this.state = state_1.emptyState(false);
        this.previous = view_1.View.none();
        this.current = view_1.View.none();
        this.other = view_1.View.none();
    ...
    TreeWorker.prototype.ascend = function (mode, expandParent) {
    ...
    TreeWorker.prototype.commitOther = function (replacementParent, slotIndexOffset) {
    ...
    TreeWorker.prototype.ascendToOrdinal = function (ordinal, mode, ensureBranchReserved) {
    ...
    TreeWorker.prototype.descendToOrdinal = function (ordinal, asWriteTarget) {
    ...
    TreeWorker.prototype.refocusView = function (ordinal, asAltView, asWriteTarget) {
