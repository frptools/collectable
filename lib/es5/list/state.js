...
var ListState = (function () {
    function ListState(group, owner, size, lastWrite, left, right) {
        this.group = group;
        this.owner = owner;
        this.size = size;
...
function getView(state, anchor, asWriteTarget, preferredOrdinal) {
    if (preferredOrdinal === void 0) { preferredOrdinal = -1; }
