...
export interface RemoveFn {
  <K, V>(key: K, tree: RedBlackTree<K, V>): RedBlackTree<K, V>;
  <K, V>(key: K): (tree: RedBlackTree<K, V>) => RedBlackTree<K, V>;
}
export const remove: RemoveFn = curry2(_remove);

export interface SetFn {
  <K, V>(key: K, value: V, tree: RedBlackTree<K, V>): RedBlackTree<K, V>;
  <K, V>(key: K): (value: V, tree: RedBlackTree<K, V>) => RedBlackTree<K, V>;
  <K, V>(key: K, value: V): (tree: RedBlackTree<K, V>) => RedBlackTree<K, V>;
  <K, V>(key: K): (value: V) => (tree: RedBlackTree<K, V>) => RedBlackTree<K, V>;
}
...
export interface UpdateTreeFn {
  <K, V>(callback: UpdateTreeCallback<K, V>, tree: RedBlackTree<K, V>): RedBlackTree<K, V>;
  <K, V>(callback: UpdateTreeCallback<K, V>): (tree: RedBlackTree<K, V>) => RedBlackTree<K, V>;
}
export const updateTree: UpdateTreeFn = curry2(_updateTree);

export interface UpdateFn {
  <K, V>(callback: UpdateTreeEntryCallback<K, V|undefined>, key: K, tree: RedBlackTree<K, V>): RedBlackTree<K, V>;
  <K, V>(callback: UpdateTreeEntryCallback<K, V|undefined>): (key: K, tree: RedBlackTree<K, V>) => RedBlackTree<K, V>;
  <K, V>(callback: UpdateTreeEntryCallback<K, V|undefined>, key: K): (tree: RedBlackTree<K, V>) => RedBlackTree<K, V>;
  <K, V>(callback: UpdateTreeEntryCallback<K, V|undefined>): (key: K) => (tree: RedBlackTree<K, V>) => RedBlackTree<K, V>;
}
...
export interface GetFn {
  <K, V>(key: K, tree: RedBlackTree<K, V>): V|undefined;
  <K, V>(key: K): (tree: RedBlackTree<K, V>) => V|undefined;
}
export const get: GetFn = curry2(_get);

export interface HasFn {
  <K, V>(key: K, tree: RedBlackTree<K, V>): boolean;
  <K, V>(key: K): (tree: RedBlackTree<K, V>) => boolean;
}
export const has: HasFn = curry2(_has);

export interface IterateFromKeyFn {
  <K, V>(reverse: boolean, key: K, tree: RedBlackTree<K, V>): RedBlackTreeIterator<K, V>;
  <K, V>(reverse: boolean): (key: K, tree: RedBlackTree<K, V>) => RedBlackTreeIterator<K, V>;
  <K, V>(reverse: boolean, key: K): (tree: RedBlackTree<K, V>) => RedBlackTreeIterator<K, V>;
  <K, V>(reverse: boolean): (key: K) => (tree: RedBlackTree<K, V>) => RedBlackTreeIterator<K, V>;
}
...
export interface AtFn {
  <K, V>(index: number, tree: RedBlackTree<K, V>): RedBlackTreeEntry<K, V>|undefined;
  <K, V>(index: number): (tree: RedBlackTree<K, V>) => RedBlackTreeEntry<K, V>|undefined;
}
export const at: AtFn = curry2(_at);

export interface KeyAtFn {
  <K, V>(index: number, tree: RedBlackTree<K, V>): K|undefined;
  <K, V>(index: number): (tree: RedBlackTree<K, V>) => K|undefined;
}
export const keyAt: KeyAtFn = curry2(_keyAt);

export interface ValueAtFn {
  <K, V>(index: number, tree: RedBlackTree<K, V>): V|undefined;
  <K, V>(index: number): (tree: RedBlackTree<K, V>) => V|undefined;
}
export const valueAt: ValueAtFn = curry2(_valueAt);

export interface IndexOfFn {
  <K, V>(key: K, tree: RedBlackTree<K, V>): number;
  <K, V>(key: K): (tree: RedBlackTree<K, V>) => number;
}
export const indexOf: IndexOfFn = curry2(_indexOf);

export interface IterateFromIndexFn {
  <K, V>(reverse: boolean, index: number, tree: RedBlackTree<K, V>): RedBlackTreeIterator<K, V>;
  <K, V>(reverse: boolean): (index: number, tree: RedBlackTree<K, V>) => RedBlackTreeIterator<K, V>;
  <K, V>(reverse: boolean, index: number): (tree: RedBlackTree<K, V>) => RedBlackTreeIterator<K, V>;
  <K, V>(reverse: boolean): (index: number) => (tree: RedBlackTree<K, V>) => RedBlackTreeIterator<K, V>;
}
...
export interface IsEqualFn {
  <K, V>(tree: RedBlackTree<K, V>, other: RedBlackTree<K, V>): boolean;
  <K, V>(tree: RedBlackTree<K, V>): (other: RedBlackTree<K, V>) => boolean;
}
export const isEqual: IsEqualFn = curry2(_isEqual);

export interface FindFn {
  <K, V>(op: FindOp, key: K, tree: RedBlackTree<K, V>): RedBlackTreeEntry<K, V>|undefined;
  <K, V>(op: FindOp): (key: K, tree: RedBlackTree<K, V>) => RedBlackTreeEntry<K, V>|undefined;
  <K, V>(op: FindOp, key: K): (tree: RedBlackTree<K, V>) => RedBlackTreeEntry<K, V>|undefined;
  <K, V>(op: FindOp): (key: K) => (tree: RedBlackTree<K, V>) => RedBlackTreeEntry<K, V>|undefined;
}
...
export interface FindKeyFn {
  <K, V>(op: FindOp, key: K, tree: RedBlackTree<K, V>): K|undefined;
  <K, V>(op: FindOp): (key: K, tree: RedBlackTree<K, V>) => K|undefined;
  <K, V>(op: FindOp, key: K): (tree: RedBlackTree<K, V>) => K|undefined;
  <K, V>(op: FindOp): (key: K) => (tree: RedBlackTree<K, V>) => K|undefined;
}
...
export interface FindValueFn {
  <K, V>(op: FindOp, key: K, tree: RedBlackTree<K, V>): V|undefined;
  <K, V>(op: FindOp): (key: K, tree: RedBlackTree<K, V>) => V|undefined;
  <K, V>(op: FindOp, key: K): (tree: RedBlackTree<K, V>) => V|undefined;
  <K, V>(op: FindOp): (key: K) => (tree: RedBlackTree<K, V>) => V|undefined;
}
...
export interface IterateFromFn {
  <K, V>(op: FindOp, reverse: boolean, key: K, tree: RedBlackTree<K, V>): RedBlackTreeIterator<K, V>;
  <K, V>(op: FindOp, reverse: boolean, key: K): (tree: RedBlackTree<K, V>) => RedBlackTreeIterator<K, V>;
  <K, V>(op: FindOp, reverse: boolean): (key: K, tree: RedBlackTree<K, V>) => RedBlackTreeIterator<K, V>;
  <K, V>(op: FindOp, reverse: boolean): (key: K) => (tree: RedBlackTree<K, V>) => RedBlackTreeIterator<K, V>;
  <K, V>(op: FindOp): (reverse: boolean, key: K, tree: RedBlackTree<K, V>) => RedBlackTreeIterator<K, V>;
...
export interface UnwrapFn {
  <K, V>(deep: boolean, tree: RedBlackTree<K, V>): Associative<V>;
  <K, V>(deep: boolean): (tree: RedBlackTree<K, V>) => Associative<V>;
}
