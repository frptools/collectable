import { Equatable, Hashable, Persistent, RecursiveUnwrappable, UpdaterFn, commit, modify, update as _update } from '@frptools/structural';

export type CollectionEntry<K, V> = [K, V]|{key: K, value: V}|K|V;

export interface Collection<T, U = any> extends Persistent, Equatable, Hashable, RecursiveUnwrappable<U>, Iterable<T> {
